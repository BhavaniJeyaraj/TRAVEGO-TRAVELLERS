...
/*f.What will be the Sitting and Sleeper bus charge for Pallavi to travel from Bangalore to PaBnaji? (5 marks)*/
SELECT * FROM Passenger;
SELECT * FROM Price;
